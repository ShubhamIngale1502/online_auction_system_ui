  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div className="navbar-nav">
       ...
       <NavLink className="nav-link active text-warning" to="/register">RegisterUser</NavLink>
       <NavLink className="nav-link active text-warning" to="/show_Details">Bank_Details</NavLink>
      </div>
